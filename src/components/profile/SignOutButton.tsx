...
export const SignOutButton = () => {
  return (
    <View>
      <TouchableOpacity className="flex-row justify-center items-center p-[18px] rounded-[24px] border border-border-elevated mt-2.5 bg-surface-raised active:bg-surface-highlight">
